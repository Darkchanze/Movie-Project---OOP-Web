...
class StorageJson(IStorage):
    ...
    def __init__(self, file_path: str):
        ...
        Args:
            file_path (str): Path to the JSON file used for storage of movies_data
    ...
    def write_movies_json(self, data: dict):
        """
    ...
    def list_movies(self):
        ...
        """
        movies_data_dict = self.read_movies_json()
    ...
    def add_movie(self, title: str, year: int, rating: float, poster_url: str):
        ...
        self.write_movies_json(movies_data_dict)
